...
import { useMarkdownPreviewInit } from '../../../Editor/components/EditorMd/hooks/use-markdown-init'
import { app } from '@/app'

defineOptions({
  name: 'EditorMdPreviewIndex2Component'
})
...
<style lang="scss">
@forward '../../../Editor/components/EditorMd/index.scss';
@forward '../../../Editor/components/EditorMd/index-theme.scss';
@forward '../../../Editor/components/EditorMd/index-mermaid.scss';
@forward './index.scss';
